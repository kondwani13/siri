<template>
<div class=" z-1000">
  <body class="overflow-hidden dark:bg-gray-900 absolute z-50 top-96 pt-96">
        <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div class="flex justify-center items-center lg:flex-row flex-col gap-8">
                <!-- Description Div -->
       
                <div class="w-full sm:w-96 mt-96 rounded shadow p-4 bg-white md:w-8/12 lg:w-6/12 items-center">
                   <div class="flex">
                    <p class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600  dark:text-white">Product / Pulse / Six pack</p>
                    ...
                    <h2 class="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 dark:text-white mt-4">Pulse Lime</h2>
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600  mt-7">Pulse is a refreshing and vibrant alcoholic beverage that's perfect for those who want to unwind and enjoy a tasty drink. Made with premium quality ingredients, Pulse delivers a smooth and subtle taste that's sure to please.</p>
                    <p class="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 dark:text-white">K 140</p>
                    ...
                    <div class="lg:mt-11 mt-10">
                        ...
                        <div class="flex flex-row justify-between items-center mt-4" @click="rotate()">
                            <p class="font-medium text-base leading-4 text-gray-600 ">Spin the bottle</p>
                            <img  id="rotateSVG" v-if="rotateimg==false" class="w-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer transform duration-100  dark:hidden" src="../assets/bottle.svg" alt="dropdown">
                            <img  id="rotateSVG" v-if="rotateimg==true"  class="w-4 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer transform duration-100  dark:hidden rotate-360" src="../assets/bottle18.svg" alt="dropdown">
                ...
                <div class="w-full sm:w-96 md:w-8/12 lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div class="w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img class="w-40" src="https://i.ibb.co/VQfJG3Y/sixp1.jpg" alt="Wooden Chair Previw" />
                    </div>
                    <div class="w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div class="bg-gray-100 flex justify-center items-center py-4">
                            <img class="w-40" src="https://i.ibb.co/VQfJG3Y/sixp1.jpg" alt="Wooden chair - preview 1" />
                        </div>
                        <div class="bg-gray-100 flex justify-center items-center py-4">
                            <img class="w-40" src="https://i.ibb.co/VQfJG3Y/sixp1.jpg" alt="Wooden chair - preview 2" />
                        </div>
