        ...
        <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div class="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div class="w-full sm:w-96 mt-14 rounded shadow p-4 bg-white md:w-8/12 lg:w-6/12 items-center">
                   <div class="flex">
                    <p class="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600  dark:text-white">Product / Gin / Double shot</p>
                    ...
                    <h2 class="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 dark:text-white mt-4">Dry Gin</h2>
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600  mt-7">Double Shot Dry Gin is a premium quality, handcrafted gin made with a unique blend of botanicals, including juniper berries, coriander seeds, angelica root, and citrus peels. It is double distilled using a traditional copper pot still to create a smooth, crisp taste with a balanced juniper flavor and a hint of floral and citrus notes.</p>
